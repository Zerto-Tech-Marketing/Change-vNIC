...
.SYNOPSIS
   ...
   script will power down the VMware VMs specificed in the NICs.csv import file, automatically change the network adapter for those VMs in vCenter to VMXNet3, and power them on. 
